...
import { Search, Bell, ChevronDown, User, Sparkles, LogOut, Menu } from 'lucide-react';
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <h2 className="text-[20px] lg:text-[24px] font-bold text-ink-primary tracking-tight leading-tight truncate">
              Boa noite, <span className="text-accent">Ronaldo</span>
            </h2>
          ...
          <div className="relative flex-shrink-0">
            ...
            >
              ...
              <div className="hidden lg:block text-left">
                ...
                <p className="text-[9px] text-ink-secondary mt-0.5">Corretor de Imóveis</p>
              </div>
