/**
 * FASE 25: Prioridade Comercial e Fadiga de Envio
 *
 * A temperatura/score comercial (0–10) e o histórico de engajamento
 * NÃO alteram o percentual do Match (que é puramente baseado no perfil e regras).
 *
 * Em vez disso, compõem a `commercial_priority`, usada internamente para
 * ordenar com prioridade comercial os leads compatíveis com o imóvel.
 */

export interface CommercialPriorityInput {
  matchScore: number;           // 0–100
  aiScore: number;              // 0–10 (temperatura comercial do lead)
  profileMaturity: number;      // 0–100
  recentInteractionDays?: number | null; // Dias desde a última interação
