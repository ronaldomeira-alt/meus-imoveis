...
/**
 * Perfil estruturado de busca do lead para cálculo de Maturidade e Match (origem WACRM).
 */
 ...
 * Suporta tanto imóvel individual quanto empreendimento com faixas/opções.
 */
...
/**
 * Registro de Match persistido no banco compartilhado.
 */
export interface MatchRecord {
  ...
  // Metadados do Lead para exibição na UI de Meus Imóveis
  lead?: {
    id: string;
    name: string;
    initials: string;
    ...
    aiScore: number;
    maturity: number;
    profile?: Partial<LeadSearchProfile>;
    pausedAt?: string | null;
    archivedAt?: string | null;
    totalPropertiesSent?: number;
    lastSentAt?: string | null;
  };
  
  // Projeção do imóvel correspondente
...
/**
 * Evento de rastreamento disparado pela página pública.
 */
